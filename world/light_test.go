...
func TestEffectiveLighting(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := EffectiveLighting(tt.material, shapes.NewSphere(), tt.light, tt.point, tt.eyeVec, tt.normalVec, false)
...
func TestLightingWithShadows(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := EffectiveLighting(tt.material, shapes.NewSphere(), tt.light, tt.point, tt.eyeVec, tt.normalVec, tt.inShadow)
